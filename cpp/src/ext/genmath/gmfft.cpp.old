...
long srTFFT::LenGoodNumbers = 1151; //637;

long srTFFT::GoodNum100s[] = { 0,37,61,79,95,107,120,130,142,151,159 };
long srTFFT::LenGoodNum100s = 11;

long srTFFT::GoodNum1000s[] = { 0,159,228,279,318,354,383,410,435,459,479 };
long srTFFT::LenGoodNum1000s = 11;

long srTFFT::GoodNum10000s[] = { 0,479,636,743,830,900,960,1017,1064,1109,1150 };
long srTFFT::LenGoodNum10000s = 11;

//*************************************************************************

void srTFFT::NextCorrectNumberForFFT(long& n)
{
	if(n < 4)
	{
		n = 4; return;
...
int srTFFT1D::Make1DFFT_InPlace(srTFFT1DInfo& FFT1DInfo)
{
...
int srTFFT2D::AuxDebug_TestFFT_Plans()
{//debug function to test why fftw2d_create_plan crashed at Nx=Nz=104

	for(long i=3; i<(srTFFT::LenGoodNumbers); i++)
	{
...
int srTFFT2D::Make2DFFT(srTFFT2DInfo& FFT2DInfo)
{// Assumes Nx, Ny even !
...
int srTFFT1D::Make1DFFT(srTFFT1DInfo& FFT1DInfo)
{// Assumes Nx, Ny even !
	const double RelShiftTol = 1.E-06;
...
int srTFFT1D::SetupAuxDataForSharpEdgeCorr(srTFFT1DInfo& FFT1DInfo, srTAuxDataForSharpEdgeCorr1D& AuxDataForSharpEdgeCorr)
{
	...
	srTFFT1DInfo FFT1DInfoLoc = FFT1DInfo;
...
void srTFFT1D::MakeSharpEdgeCorr(srTFFT1DInfo& FFT1DInfo, srTAuxDataForSharpEdgeCorr1D& AuxData)
{
