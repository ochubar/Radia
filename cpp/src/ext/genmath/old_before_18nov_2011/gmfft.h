...
#define MEMORY_ALLOCATION_FAILURE 8 + 23000 //in line with SRW
#endif
#ifndef ERROR_IN_FFT
#define ERROR_IN_FFT 40 + 23000
#endif
...
struct srTFFT2DInfo {
	...
	srTFFT2DInfo() { UseGivenStartTrValues = 0;}
};

//*************************************************************************

class srTFFT2D : public srTFFT {
...
public:
	...
	int Make2DFFT(srTFFT2DInfo&);
	int AuxDebug_TestFFT_Plans();

	void SetupLimitsTr(srTFFT2DInfo& FFT2DInfo)
...
struct srTAuxDataForSharpEdgeCorr1D {
...
public:
	...
	int Make1DFFT(srTFFT1DInfo&);
	int Make1DFFT_InPlace(srTFFT1DInfo& FFT1DInfo);

	void SetupLimitsTr(srTFFT1DInfo& FFT1DInfo)
	...
	int SetupAuxDataForSharpEdgeCorr(srTFFT1DInfo&, srTAuxDataForSharpEdgeCorr1D&);
	void MakeSharpEdgeCorr(srTFFT1DInfo&, srTAuxDataForSharpEdgeCorr1D&);
	...
	int ProcessSharpEdges(srTFFT1DInfo& FFT1DInfo)
	{
		srTAuxDataForSharpEdgeCorr1D AuxDataForSharpEdgeCorr;
